...
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///' + os.path.abspath(DB_PATH + '/mean-sentiment-db.sqlite') 
...
@app.route("/api/mean-sentiment/<string:table>", methods=["GET", "POST"], strict_slashes=False)
def list(table):
